...
/* Written by Agustin Alexander, Andres Sciacca, Maximiliano Lencina, Danilo Eidelson */
...
const char *program_authors[] = {
	"Agustin Alexander, Andres Sciacca, Maximiliano Lencina, Danilo Eidelson",
	NULL
};
...
# endif
  ...
  while (!stop)
	...
	exit (EXIT_FAILURE);
      ...
      hop = hop + 2; /* Modificacion de salto de a 2 unidades */
    }
